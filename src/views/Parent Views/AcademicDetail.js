...
export default function AcademicDetail() {
  ...
  useEffect(() => {
    dispatch(getStudentAttendaceList(username));
  }, [username]);
  return (
    <>
        ...
        <Row>
          <Col sm={12} md={12} lg={12} className="attendance">
            <LoadingOverlay
              active={loading}
              spinner
              text="Attendance Percentage Loading...."
            >
            ...
            <ModalBody>
              ...
              <div className="d-flex justify-content-center align-items-center my-3">
                <Button
                  ...
                  onClick={() =>
                    history.push({
                      pathname: `/parent/view-attendance/${enrollmentID}`,
                      state: {attendanceDetail:attendanceDetail,username:username},
                    })
                  }
                >
                  Attendance
